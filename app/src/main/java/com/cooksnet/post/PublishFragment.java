...
public class PublishFragment extends SearchFragment {
...
//			parent.removeView(v);
		...
		v = inflater.inflate(R.layout.publish, null, true);
...
//								page = 0;
//								canSearch = false;
//								new DeleteThread(handler, a, delete).execute(true);
//							}
...
//						}).create().show();
	...
	public void onResume() {
		...
		if (!pref.getBoolean("tabclick", false) || !alreadySearch) {
			...
			page = 0;
			canSearch = false;
			new SearchThread(handler, a, true).execute(true);
			alreadySearch = true;
		}
		Editor e = pref.edit();
